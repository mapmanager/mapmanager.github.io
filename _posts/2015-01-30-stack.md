...
There are five different window decorations or **c**andy options. Cycle different window **c**andies with keyboard <kbd>shift</kbd>+<kbd>c</kbd>.
  ...
  2. None
  3. Scale Bar
  4. Scale Bar + Top Left Label
  5. Scale Bar + Top Left Label + Scroll Bar

Set the default window **c**andy in [Options][2]. Note: The grid will only display when window **c**andy is set to 'All' (when the stack axis are visible).
...
Map Manager makes heavy use of keyboard shortcuts. Most of these functions are available in the right-click menu which also lists the corresponding keyboard shortcut. The <A HREF="#buttons-panel">buttons panel</a> provides the same functions and may be easier to use.
...
|**Window Candy**	| |
|				|shift + c		|Toggle 4 different window candy options. Use this to display/hide stack scale and copy/paste to other programs.
|**Toolbars**	| |
