...
Copy and paste a map plot to your favorite presentation software including Keynote or Powerpoint.
...
From the buttons panel, many different display options can be selected for a given map plot. This includes toggling the display of bad, intensity bad, dynamics colors and many more.
